...
var VEHICLE_FIELDS = ['id', 'plate', 'type', 'brand', 'year', 'odo', 'status', 'regExpiry', 'lastInspection', 'insuranceStart', 'insuranceExpiry', 'driverId', 'owner', 'site', 'fuelNorm', 'note'];
...
function seedVehicleRows_() {
  ...
  // insuranceStart, insuranceExpiry, driverId, owner, site, fuelNorm, note
  return [
    ['v1', '86H-0711', 'Xe con 8-9 chỗ', 'Toyota Land Cruiser', 2001, 462820, 'active', '2026-05-13', '2025-05-14', '2026-06-30', '2026-12-31', '', 'Công ty Điện lực Bình Thuận', 'CS2', '24 lít/100km', 'Đăng ký tại: ĐL T.Đ.Thắng, Xuân An, Phan Thiết, Bình Thuận. Bảo dưỡng gần nhất: cấp 1 ở 450.102 km, cấp 2 ở 456.314 km (ngưỡng 5.000 km / 30.000 km — Xe con).'],
    ['v2', '86A-016.98', 'Xe con 7 chỗ', 'Toyota Fortuner', 2013, 349697, 'active', '2026-08-12', '2025-09-12', '2026-06-30', '2026-12-31', '', 'Công ty Điện lực Bình Thuận', 'CS2', '17 lít/100km', 'Đăng ký tại: ĐL T.Đ.Thắng, Xuân An, Phan Thiết, Bình Thuận. Bảo dưỡng gần nhất: cấp 1 ở 337.190 km, cấp 2 ở 343.490 km (ngưỡng 5.000 km / 30.000 km — Xe con).'],
    ['v3', '86A-275.58', 'Xe con 7 chỗ', 'Toyota Fortuner', 2023, 76000, 'active', '2026-12-28', '2023-12-29', '2026-06-30', '2026-12-31', '', 'Công ty Điện lực Bình Thuận', 'CS2', '17 lít/100km', 'Đăng ký tại: ĐL T.Đ.Thắng, Xuân An, Phan Thiết, Bình Thuận. Bảo dưỡng gần nhất: cấp 1 ở 72.508 km, cấp 2 ở 67.320 km (ngưỡng 5.000 km / 30.000 km — Xe con).'],
    ['v4', '86H-3885', 'Xe bán tải', 'Isuzu D-Max', 2008, 30038, 'active', '2026-09-09', '2026-10-03', '2026-06-30', '2026-12-31', '', 'Công ty Điện lực Bình Thuận', 'CS2', '14 lít/100km', 'Đăng ký tại: ĐL T.Đ.Thắng, Xuân An, Phan Thiết, Bình Thuận. Bảo dưỡng gần nhất: cấp 1 ở 28.113 km, cấp 2 ở 19.985 km (ngưỡng 5.000 km / 30.000 km — Xe con/ Xe bán tải).'],
    ...
    ['v6', '86A-181.81', 'Xe con 7 chỗ', 'Hyundai Santa Fe', 2020, 99839, 'active', '2028-04-18', '2026-10-19', '2026-06-30', '2026-12-31', '', 'Công ty Điện lực Bình Thuận', 'CS2', '15 lít/100km', 'Đăng ký tại: ĐL T.Đ.Thắng, Xuân An, Phan Thiết, Bình Thuận. Bảo dưỡng gần nhất: cấp 1 ở 89.372 km, cấp 2 ở 95.172 km (ngưỡng 5.000 km / 30.000 km — Xe con).'],
    ['v7', '86B-014.73', 'Xe khách 16 chỗ', 'Hyundai Solati', 2019, 86449, 'active', '2027-01-07', '2026-07-08', '2026-06-30', '2026-12-31', '', 'Công ty Điện lực Bình Thuận', 'CS2', '17 lít/100km', 'Đăng ký tại: ĐL T.Đ.Thắng, Xuân An, Phan Thiết, Bình Thuận. Bảo dưỡng gần nhất: cấp 1 ở 77.119 km, cấp 2 ở 81.714 km (ngưỡng 5.000 km / 30.000 km — Xe ô tô 04 đến 16 chỗ).'],
    ['v8', '86A-015.56', 'Xe con 5 chỗ', 'Honda Civic', 2013, 273028, 'active', '2026-12-03', '2025-12-04', '2026-06-30', '2026-12-31', '', 'Công ty Điện lực Bình Thuận', 'CS2', '12 lít/100km', 'Đăng ký tại: ĐL T.Đ.Thắng, Xuân An, Phan Thiết, Bình Thuận. Bảo dưỡng gần nhất: cấp 1 ở 272.886 km, cấp 2 ở 265.791 km (ngưỡng 5.000 km / 30.000 km — Xe con).'],
    ['v9', '86A-086.15', 'Xe con 7 chỗ', 'Nissan X-Trail', 2018, 149817, 'active', '2027-03-17', '2026-03-18', '2026-06-30', '2026-12-31', '', 'Công ty Điện lực Bình Thuận', 'CS2', '16 lít/100km', 'Đăng ký tại: ĐL T.Đ.Thắng, Xuân An, Phan Thiết, Bình Thuận. Bảo dưỡng gần nhất: cấp 1 ở 141.888 km, cấp 2 ở 134.965 km (ngưỡng 5.000 km / 80.000 km — Xe con).'],
    ['v10', '48A-088.82', 'Xe con 7 chỗ', 'Nissan X-Trail', 2019, 121216, 'active', '2027-11-04', '2025-11-05', '2026-01-31', '2027-01-30', '', 'Công ty Điện lực Đắk Nông', 'CS3', '16 lít/100km', 'Đăng ký tại: Số 02 Lê Duẩn, phường Nghĩa Tân, TP Gia Nghĩa, tỉnh Đắk Nông. Bảo dưỡng gần nhất: cấp 1 ở 120.000 km, cấp 2 ở 120.000 km (ngưỡng 5.000 km / 30.000 km — Xe con).'],
    ['v11', '49A-995.16', 'Xe khách 16 chỗ', 'Ford Transit', 2018, 295330, 'active', '2026-10-13', '2026-04-14', '2025-12-31', '2026-12-31', '', 'Công ty Điện lực Lâm Đồng', 'CS3', '20 lít/100km', 'Đăng ký tại: Số 02 Hùng Vương, phường Xuân Hương - Đà Lạt, tỉnh Lâm Đồng. Bảo dưỡng gần nhất: cấp 1 ở 295.000 km, cấp 2 ở 270.000 km (ngưỡng 5.000 km / 30.000 km — Xe con).'],
    ...
    ['v14', '49B-172.63', 'Xe con 8-9 chỗ', 'Hyundai Starex', 2016, 371699, 'active', '2027-07-06', '2026-07-07', '2025-12-31', '2026-12-31', '', 'Công ty Điện lực Lâm Đồng', 'CS3', '18 lít/100km', 'Đăng ký tại: Số 02 Hùng Vương, phường Xuân Hương - Đà Lạt, tỉnh Lâm Đồng. Bảo dưỡng gần nhất: cấp 1 ở 370.000 km, cấp 2 ở 360.000 km (ngưỡng 5.000 km / 30.000 km — Xe con).'],
    ['v15', '49B-173.07', 'Xe con 5 chỗ', 'Toyota Camry', 2010, 470178, 'active', '2027-03-10', '2026-03-11', '2025-12-31', '2026-12-31', '', 'Công ty Điện lực Lâm Đồng', 'CS3', '20 lít/100km', 'Đăng ký tại: Số 02 Hùng Vương, phường Xuân Hương - Đà Lạt, tỉnh Lâm Đồng. Bảo dưỡng gần nhất: cấp 1 ở 470.000 km, cấp 2 ở 450.000 km (ngưỡng 5.000 km / 30.000 km — Xe con).']
  ];
}
